...
Public Class level3
    ...
    Private Sub Timer1_Tick() Handles Timer1.Tick
        ...
        If Player.Bounds.IntersectsWith(gate.Bounds) Then
            Main_form.Switchpanel(Forest)
            Main_form.mainTimer.Enabled = False
            Player.Top = Player.Top + 5
        End If

        If Player.Bounds.IntersectsWith(secretGate.Bounds) Then
            Player.Location = New Point(560, 342)
        End If
    ...
    Private Sub Level3_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
        ...
        If Not Player.Bounds.IntersectsWith(rwall1.Bounds) And
               ...
               Not Player.Bounds.IntersectsWith(rwall11.Bounds) And
        ...
        If Not Player.Bounds.IntersectsWith(lwall1.Bounds) And
                ...
                Not Player.Bounds.IntersectsWith(lock1.Bounds) And
                e.KeyChar = "a" Then
        ...
        If Not Player.Bounds.IntersectsWith(dwall1.Bounds) And
                ...
                Not Player.Bounds.IntersectsWith(lock2.Bounds) And
                e.KeyChar = "s" Then
        ...
        If Not Player.Bounds.IntersectsWith(uwall1.Bounds) And
                ...
                Not Player.Bounds.IntersectsWith(uobstacle5.Bounds) And
                Not Player.Bounds.IntersectsWith(uobstacle6.Bounds) And
                Not Player.Bounds.IntersectsWith(uobstacle7.Bounds) And
                Not Player.Bounds.IntersectsWith(uobstacle8.Bounds) And
        ...
        If e.KeyChar = "o" And Player.Bounds.IntersectsWith(chest1.Bounds) Then
            MsgBox("Sometimes we must move backwards to move ahead!")

        End If

        If e.KeyChar = "o" And Player.Bounds.IntersectsWith(chest2.Bounds) Then
            MsgBox("Look! The bridges have collapsed!")
